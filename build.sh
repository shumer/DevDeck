...
# it came from beside it. Only the menu-bar glyph is still drawn at run time.
iconutil -c icns "$HERE/Resources/AppIcon/DevDeck.iconset" -o "$APP/Contents/Resources/DevDeck.icns"
