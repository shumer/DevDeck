...
**Settings → General shows the running version** under its heading, `DevDeck 0.15 (build 125)`,
...
`v0.15`. The build number in the bundle is the commit count, so it moves on its own. A manual
